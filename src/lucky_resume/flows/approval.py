...
from lucky_resume.state import ATSScore, RejectedSuggestion, ResumeOptimizerState
...
def run_approval_loop(
    *,
    ...
    `lucky_resume.graph.build_tailor_graph` — duck-typed here so tests
    can pass a `MagicMock`.
    """
    from lucky_resume.nodes.apply_approvals import apply_approvals
    from lucky_resume.nodes.propose_changes import propose_changes, revise_proposal
