...
from lucky_resume.prompts.propose_changes import PROPOSE_CHANGES, REVISE_PROPOSAL
...
from lucky_resume.tools.source_index import SourceIndex, build_source_index
